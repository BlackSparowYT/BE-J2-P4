<nav>
    ...
    <div class="link-group">
        ...
        @if (auth()->user()->isAdmin())
            <a class="link <?php if($page=="category") { echo 'active';} ?>" href="{{ route('dashboard.category') }}">
                <i class="da-icon da-icon--folders"></i>
                <p>Categories</p>
            </a>
            <a class="link <?php if($page=="menu") { echo 'active';} ?>" href="{{ route('dashboard.menu') }}">
                <i class="da-icon da-icon--files"></i>
                <p>Menu</p>
            </a>
